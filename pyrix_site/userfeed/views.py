...
from userfeed.models import Feed, Subscription, Update
from userfeed.forms import SubscriptionForm


def feed(request, feed_id=None, content_type=None, object_id=None, template_name='detail.html'):
    """
    display feed
    """
...
def feeds(request, mine=True, username=None, template_name='feeds.html'):
    """
    list feeds
    """
    if mine:
...
def subscription(request, feed_id=None, content_type=None, object_id=None,
    add_messages=False, ajax=False, template_name='subscription.html'):
    """
    post subscription
    """
    if feed_id: # feed_id takes priority (fastest)
...
def follow_form(request, feed_id=None, template_name='subscription.html'):
    """
    follow
    """
    if feed_id: # feed_id takes priority (fastest)
    ...
    return render_to_response('follow_form.html', {'feed': feed,
